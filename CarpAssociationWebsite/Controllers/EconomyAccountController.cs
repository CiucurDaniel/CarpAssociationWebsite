...
namespace CarpAssociationWebsite.Controllers
{
    public class EconomyAccountController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EconomyAccountId,TotalSavings,DateStarted")] EconomyAccount economyAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EconomyAccountId,TotalSavings,DateStarted")] EconomyAccount economyAccount)
        {
            if (ModelState.IsValid)
            {
